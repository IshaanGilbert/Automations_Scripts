...
"""EstuaryEmailAccounts -- sheet ke email/password se account banane wali exe.

Ye purani EstuaryAccountCreator ki JAGAH NAHI leti. Wo mobile+OTP se account
banati hai aur naam/email khud gadhti hai; ye 'Account_emails' tab ki
bani-banayi rows se banati hai. Dono alag exe hain, alag folder me banti hain,
aur ek doosre ko chhedti nahi.
...
BANANA
    pyinstaller --noconfirm EstuaryEmailAccounts.spec
...
exe = EXE(
    ...
    name="EstuaryEmailAccounts",
    debug=False,
    bootloader_ignore_signals=False,
    strip=False,
    upx=False,
    # GUI hai, isliye console nahi. Har line window ke log me aur
    # gui_log_email.txt me jaati hai -- console na hone par bhi kuch chhupta nahi.
    console=False,
