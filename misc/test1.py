...
CHROMEDRIVER_PATH = resource_path("chromedriver")  # ChromeDriver in project folder
CHROME_BINARY_PATH = resource_path("google-chrome-stable")  # Chrome binary in project folder's 'chrome' subfolder
...
def run_profile(run_index, token):
    ...
    try:
        profile_id = gl.createProfileWithCustomParams({
            ...
            "chromeVersion": "137",
            "navigator": {
                "userAgent": "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.7151.69 Safari/537.36",  # ✅ Updated
