...
#         handlers=[
#             logging.FileHandler(log_file, mode='a', encoding='utf-8'),  # File me UTF-8
...
# # BATCH CONFIGURATION
# TOTAL_VISITS = 10000  # Total number of visits to perform
# SESSIONS_PER_BATCH = 3  # Number of concurrent sessions in each batch
# DELAY_BETWEEN_SESSIONS = (10, 15)  # Random delay between starting each session (seconds)
...
# ---------- CONFIG ----------
TARGET_URLS = [
    "https://skyscanner.pxf.io/AgkYER",
]
